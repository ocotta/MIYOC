...
public class HomePage_TabHost extends Activity {
	 ...
	 * By using TabSpec setIndicator() we can set name to tab. */
	 ...
	 TabSpec eTabSpec = tabHost.newTabSpec("Login");
	 eTabSpec.setIndicator("Login");
	 eTabSpec.setContent(new Intent(this,Members.class));
