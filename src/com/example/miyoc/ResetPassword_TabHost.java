...
public class ResetPassword_TabHost extends Activity {
	 ...
	 * By using TabSpec setIndicator() we can set name to tab. */
	 ...
	 TabSpec eTabSpec = tabHost.newTabSpec("Reset");
	 eTabSpec.setIndicator("Reset");
	 eTabSpec.setContent(new Intent(this,ResetPassword.class));
