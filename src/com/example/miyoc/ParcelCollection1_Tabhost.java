...
public class ParcelCollection1_Tabhost extends Activity {
	 ...
	 * By using TabSpec setIndicator() we can set name to tab. */
	 ...
	 TabSpec thirdTabSpec = tabHost.newTabSpec("ParcelCollection");
	 thirdTabSpec.setIndicator("Check Parcel");
	 thirdTabSpec.setContent(new Intent(this,ParcelCollection1.class));
	 ...
	 TabSpec nTabSpec = tabHost.newTabSpec("MemberPage");
	 nTabSpec.setIndicator("MemberPage");
	 nTabSpec.setContent(new Intent(this,MemberMain.class));
