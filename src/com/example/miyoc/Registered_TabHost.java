...
public class Registered_TabHost extends Activity {
...
TabSpec seventhTabSpec = tabHost.newTabSpec("Member");
seventhTabSpec.setIndicator("Member");
seventhTabSpec.setContent(new Intent(this,Members.class));
tabHost.addTab(seventhTabSpec);

TabSpec eTabSpec = tabHost.newTabSpec("Registered");
eTabSpec.setIndicator("Registered");
eTabSpec.setContent(new Intent(this,Registered.class));
